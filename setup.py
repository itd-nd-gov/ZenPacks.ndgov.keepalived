...
NAME = "ZenPacks.ndgov.keepalived"
VERSION = "0.1.0"
AUTHOR = "State of North Dakota Information Technology Department (Robert Hart)"
LICENSE = "MIT"
NAMESPACE_PACKAGES = ['ZenPacks', 'ZenPacks.ndgov']
PACKAGES = ['ZenPacks', 'ZenPacks.ndgov', 'ZenPacks.ndgov.keepalived']
INSTALL_REQUIRES = []
